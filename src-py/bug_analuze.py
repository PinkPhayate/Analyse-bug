...
for ver in vers :
    ...
    bug_modules = get_all_bug_modules(list)
    ...
    # save bug modules
    bug_modules.to_csv( './../metrics/numBug/slr_'+ver+'_bgmd_all.csv', index=False, cols=None )
...
for ver in vers :
    filename = './../metrics/numBug/slr_'+ver+'_bgmd_all.csv'
